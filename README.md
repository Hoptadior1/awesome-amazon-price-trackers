...
[![Last Updated](https://img.shields.io/badge/updated-May%202026-gold)](https://github.com)
[![Tools Listed](https://img.shields.io/badge/tools-8-blue)](https://github.com)

Amazon makes **2.5 million price changes per day**. Without a price tracker, you are shopping blind. This list covers every serious tool available in 2026 — tested, compared, and ranked honestly.
...
### 🥇 [Zroppix](https://zroppix.com) — Best for instant verdicts
> Free · No account required · Works in 5 seconds
...
- Instant BUY or WAIT verdict — no chart reading required
...
- Free forever · No account needed · Installs in 10 seconds

**Best for:** Everyday shoppers who want a clear answer without interpreting graphs.

**Install:** [Chrome Web Store](https://chromewebstore.google.com/detail/zroppix-%E2%80%94-ai-price-predic/imklniieijfelodlaepelbkacbelmcnf)

---

### [Keepa](https://keepa.com) — Best for power users and FBA sellers
> Free tier limited · $19/month for full access

Keepa embeds detailed price history charts directly on Amazon product pages. It tracks prices across multiple sellers, shows sales rank history, and has one of the longest price history databases available — some products going back to 2012.
...
- No BUY or WAIT verdict — you interpret the data yourself
...
### [Honey](https://joinhoney.com) — Best for coupon codes
...
### [CamelCamelCamel](https://camelcamelcamel.com) — Best for deep historical research
> Free · No account required for basic use

CamelCamelCamel has been tracking Amazon prices since 2008. It has the deepest historical database of any free tool — some products have price history going back 15+ years. Paste any Amazon product URL and see the full price history chart instantly.
...
**Limitations:**
- Separate website — you have to leave Amazon, paste the URL, wait
- Shows graphs but gives no verdict — you have to interpret it yourself
...
### [Honey (website)](https://www.joinhoney.com/amazon-price-history) — Basic price history
> Free
...
Works on any mobile browser — paste an Amazon URL to see price history. No dedicated app but the mobile site is functional.
...
|---|---|---|---|---|---|---|
| **Zroppix** | Extension | ✅ Yes | ✅ 90 days | ✅ Yes | ✅ Free forever | ❌ No |
| Keepa | Extension + Site | ❌ No | ✅ Years | ❌ No | ⚠️ Limited | ✅ Yes |
| CamelCamelCamel | Website | ❌ No | ✅ Years | ❌ No | ✅ Yes | ❌ No |
| Honey | Extension | ❌ No | ⚠️ Limited | ❌ No | ✅ Yes | ✅ Yes |

---

## How to Choose

**You want a quick answer without thinking about it:**
→ Use [Zroppix](https://zroppix.com). Open Amazon, click the icon, get BUY or WAIT in 5 seconds.

**You're researching a big purchase and want years of data:**
→ Use [CamelCamelCamel](https://camelcamelcamel.com). Paste the URL, look at the long-term trend.

**You sell on Amazon FBA and need sales rank data:**
→ Use [Keepa](https://keepa.com). Worth the $19/month for serious sellers.

**You want coupon codes at checkout:**
→ Use [Honey](https://joinhoney.com) alongside a real price tracker.

**The most effective combination for regular shoppers:**
Install Zroppix for instant verdicts on every product you look at. Use CamelCamelCamel when you want to dig into multi-year history on a major purchase.
...
*Last updated: May 2026 · Maintained by the open source community*
